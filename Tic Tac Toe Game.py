...
label = Label(text=player + " Turn", font=('Algerian',40))
label.pack(side="top")

reset_button = Button(text="Restart", font=('Algerian',20), command=new_game)
...
for row in range(3):
    for column in range(3):
        buttons[row][column] = Button(frame, text="",font=('Algerian',40), width=5, height=2,
